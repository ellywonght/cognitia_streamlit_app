...
def menu_screen():
    ...
    if all_tests_completed():
        ...
        st.markdown(
            "<br><button disabled style='background-color: #5D5CDE; color: white; width: 100%; padding: 0.75em; font-size: 1em; border-radius: 10px; border: none;'>View Results</button>"
