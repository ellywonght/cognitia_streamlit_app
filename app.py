...
# Step 1: Text Input Instead of Speech
...
# Step 3: Eye Tracking Simulation
    ...
    st.image("https://upload.wikimedia.org/wikipedia/commons/6/66/Eye_Movement_Example.gif", caption="模擬眼動範例")
...
# Step 4: PLR Simulation
    ...
    st.image("https://upload.wikimedia.org/wikipedia/commons/2/27/Pupil_response_to_light.gif", caption="模擬PLR反應")
